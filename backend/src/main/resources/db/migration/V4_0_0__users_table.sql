...
CREATE TABLE USERS
  (
    ...
    PASSWORD_SALT               VARCHAR2(500 CHAR)   CONSTRAINT "C_NN_USERS_PWD_SALT" NOT NULL,
    HASH_SIZE                   NUMBER(10, 0)        CONSTRAINT "C_NN_USERS_HASH_SIZE" NOT NULL,
    HASH_ALGORITHM              VARCHAR2(100 CHAR)   CONSTRAINT "C_NN_USERS_HASH_ALGO" NOT NULL,
    SALT_ALGORITHM              VARCHAR2(100 CHAR)   CONSTRAINT "C_NN_USERS_SALT_ALGO" NOT NULL,
